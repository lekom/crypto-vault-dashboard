...
export declare const createTokenConfig: <const tokens>(tokens: TokensConfig<Narrow<tokens>>) => Prettify<tokens>;
...
export declare const createCustomConfig: <custom>(custom: CustomConfig<custom>) => Prettify<custom>;
