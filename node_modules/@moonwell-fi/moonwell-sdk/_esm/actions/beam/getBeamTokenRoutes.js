 ...
 */
export async function getBeamTokenRoutes(client) {
    const environments = getEnvironmentsFromArgs(client, undefined, false);
    const acrossRoutesResponse = await axios.get("https://across.to/api/available-routes");
    const biconomyInfoResponse = await axios.get("https://network.biconomy.io/v1/info");
    const moonwellSupportedTokens = environments
        ...
        .filter((r) => r.symbol.toLowerCase() !== "usdbc" && r.symbol.toLowerCase() !== "weth"); //How to handle it?
