...
import { createMeeClient, greaterThanOrEqualTo, runtimeERC20BalanceOf, runtimeEncodeAbiParameters, toMultichainNexusAccount, } from "@biconomy/abstractjs";
import { http, createPublicClient, encodeFunctionData, getContract, parseAbi, zeroAddress, } from "viem";
...
export async function getQuote(client, args) {
    const envs = getEnvironmentsFromArgs(client, undefined, false).filter((env) => env.chainId !== moonbeam.id && env.chainId !== moonriver.id);
