...
exports.custom = exports.contracts = exports.morphoMarkets = exports.vaults = exports.tokens = exports.markets = exports.createEnvironment = void 0;
const viem_1 = require("viem");
const chains_1 = require("viem/chains");
const config_js_1 = require("../../types/config.js");
const contracts_js_1 = require("./contracts.js");
Object.defineProperty(exports, "contracts", { enumerable: true, get: function () { return contracts_js_1.contracts; } });
...
const optimism = (0, viem_1.defineChain)({ ...chains_1.optimism, testnet: false });
const createEnvironment = (rpcUrls, indexerUrl, governanceIndexerUrl) => (0, config_js_1.createEnvironmentConfig)({
    key: "optimism",
    name: "OP Mainnet",
    chain: {
        ...optimism,
    ...
    transport: rpcUrls
        ...
        : (0, viem_1.http)(optimism.rpcUrls.default.http[0]),
