...
exports.tokens = exports.polygon = exports.createEnvironment = void 0;
...
const createEnvironment = (rpcUrls, indexerUrl, governanceIndexerUrl) => (0, config_js_1.createEnvironmentConfig)({
    ...
    chain: {
        ...chains_1.polygon,
        rpcUrls: {
            default: { http: rpcUrls || chains_1.polygon.rpcUrls.default.http },
        },
    },
    transport: rpcUrls
        ? (0, viem_1.fallback)(rpcUrls.map((url) => (0, viem_1.http)(url)))
        : (0, viem_1.http)(chains_1.polygon.rpcUrls.default.http[0]),
