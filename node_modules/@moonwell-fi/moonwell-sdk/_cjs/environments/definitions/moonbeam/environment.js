...
exports.tokens = exports.markets = exports.createEnvironment = exports.moonbeam = void 0;
...
const createEnvironment = (rpcUrls, indexerUrl, governanceIndexerUrl) => (0, config_js_1.createEnvironmentConfig)({
    ...
    chain: {
        ...chains_1.moonbeam,
        rpcUrls: {
            default: { http: rpcUrls || chains_1.moonbeam.rpcUrls.default.http },
        },
    },
    transport: rpcUrls
        ? (0, viem_1.fallback)(rpcUrls.map((url) => (0, viem_1.http)(url)))
        : (0, viem_1.http)("https://rpc.api.moonbeam.network"),
