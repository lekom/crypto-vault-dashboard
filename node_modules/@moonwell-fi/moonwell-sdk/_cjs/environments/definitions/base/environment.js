...
exports.vaults = exports.tokens = exports.morphoMarkets = exports.markets = exports.createEnvironment = exports.base = void 0;
...
const createEnvironment = (rpcUrls, indexerUrl, governanceIndexerUrl) => (0, config_js_1.createEnvironmentConfig)({
    ...
    transport: rpcUrls
        ...
        : (0, viem_1.fallback)([
            ...
            (0, viem_1.http)("https://base-mainnet.public.blastapi.io"),
            (0, viem_1.http)("https://base.lava.build"),
        ]),
