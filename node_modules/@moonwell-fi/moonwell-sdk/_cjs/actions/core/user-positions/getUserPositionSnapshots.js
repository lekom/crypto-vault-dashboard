...
exports.getUserPositionSnapshots = getUserPositionSnapshots;
...
async function fetchUserPositionSnapshots(userAddress, environment) {
    ...
    while (hasNextPage) {
        ...
        dailyData.push(...result.data.data.accountDailySnapshots.items.filter((f) => (0, index_js_1.isStartOfDay)(f.timestamp)));
...
//# sourceMappingURL=getUserPositionSnapshots.js.map