...
exports.getSnapshotProposalData = void 0;
const axios_1 = __importDefault(require("axios"));
const index_js_1 = require("../../../environments/index.js");
const getSnapshotProposalData = async (params) => {
    ...
    const response = await axios_1.default.post(snapshotApiUrl, {
        query: `{
          spaces(
            where: {
    ...
    if (response.status === 200 && response.data?.data?.proposals) {
        ...
        const result = response.data.data.proposals.map((proposal) => {
            ...
            let chain = Object.values(index_js_1.supportedChains).find((c) => c.id === networkId);
            if (proposal.title.toLowerCase().includes("base")) {
                chain = index_js_1.base;
            }
            if (proposal.title.toLowerCase().includes("optimism")) {
                chain = index_js_1.optimism;
            }
...
exports.getSnapshotProposalData = getSnapshotProposalData;
