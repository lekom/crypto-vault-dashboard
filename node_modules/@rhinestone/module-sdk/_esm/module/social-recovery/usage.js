...
import { encodeFunctionData, encodePacked, getAddress, } from 'viem';
import { abi } from './abi.js';
import { GLOBAL_CONSTANTS } from '../../constants.js';
export const getSetSocialRecoveryThresholdAction = ({ threshold, }) => {
...
export const getAddSocialRecoveryGuardianAction = ({ guardian, }) => {
    const data = encodeFunctionData({
...
export const getRemoveSocialRecoveryGuardianAction = async ({ client, account, guardian, }) => {
...
export const getSocialRecoveryGuardians = async ({ account, client, }) => {
    try {
...
export const getSocialRecoveryMockSignature = ({ threshold, }) => {
    ...
    return encodePacked(Array(threshold).fill('bytes'), Array(threshold).fill(mockSignature));
};
