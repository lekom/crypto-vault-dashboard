 ...
 * ```
 */
export const prepareSignableQuotePayload = (quote) => {
    return {
        signablePayload: {
 ...
 * ```
 */
export const formatSignedQuotePayload = (quote, _metadata, // This is unused for now. But can be extended in future
signature) => {
    return {
        ...quote,
