import { concatHex, formatUnits, getAddress, padHex, parseAbi, zeroAddress } from "viem";
import { greaterThanOrEqualTo, runtimeERC20BalanceOf } from "../../../modules/utils/composabilityCalls.js";
import { createChainAddressMap } from "../../../modules/utils/createChainAddressMap.js";
import buildBatch from "./buildBatch.js";
import { buildComposableUtil } from "./buildComposable.js";
 ...
 */
export const buildAcrossIntentComposable = async (baseParams, parameters, composabilityParams) => {
 ...
 * })
 */
export async function getAcrossSuggestedFees(parameters) {
...
export function calculateAcrossFees(parameters) {
 ...
 */
export function formatAcrossFeePercentage(pct) {
