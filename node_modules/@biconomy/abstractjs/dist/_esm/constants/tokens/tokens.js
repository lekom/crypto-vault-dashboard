...
export const mcAUSDC = getMultichainContract({
    abi: erc20Abi,
    deployments: [
...
export const testnetMcUSDC = getMultichainContract({
    abi: erc20Abi,
    deployments: [
...
export const testnetMcFusion = getMultichainContract({
    abi: erc20Abi,
    deployments: [["0x232fb0469e5fc7f8f5a04eddbcc11f677143f715", baseSepolia.id]]
});
export const mcWeth = getMultichainContract({
    abi: erc20Abi,
    deployments: [
