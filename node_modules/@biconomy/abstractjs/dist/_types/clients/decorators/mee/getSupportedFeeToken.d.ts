 ...
 */
export declare const getSupportedFeeToken: (client: BaseMeeClient, parameters: GetSupportedFeeTokenParams) => Promise<GetSupportedFeeTokenPayload>;
export default getSupportedFeeToken;
//# sourceMappingURL=getSupportedFeeToken.d.ts.map