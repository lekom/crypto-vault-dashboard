...
import { type SignQuoteParams } from "./signQuote";
/**
 ...
 */
export declare const executeQuote: (client: BaseMeeClient, params: SignQuoteParams) => Promise<ExecuteSignedQuotePayload>;
