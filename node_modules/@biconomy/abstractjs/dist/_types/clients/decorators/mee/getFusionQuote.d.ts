...
import { type CleanUp, type GetQuoteParams, type Instruction } from "./getQuote";
...
export declare const prepareInstructions: (client: BaseMeeClient, parameters: PrepareInstructionsParams) => Promise<{
    triggerGasLimit: bigint;
    triggerAmount: bigint;
    batchedInstructions: Instruction[];
}>;
