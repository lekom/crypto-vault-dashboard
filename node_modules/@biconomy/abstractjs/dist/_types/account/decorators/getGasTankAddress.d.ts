...
export declare const getGasTankAddress: (mcNexus: MultichainSmartAccount, parameters: GetGasTankAddressParams) => Promise<GetGasTankAddressPayload>;
export default getGasTankAddress;
//# sourceMappingURL=getGasTankAddress.d.ts.map