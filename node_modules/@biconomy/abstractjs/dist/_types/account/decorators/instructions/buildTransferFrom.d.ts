 ...
 * ```
 */
export declare const buildTransferFrom: (baseParams: BaseInstructionsParams, parameters: BuildTransferFromParameters, composabilityParams?: ComposabilityParams) => Promise<Instruction[]>;
