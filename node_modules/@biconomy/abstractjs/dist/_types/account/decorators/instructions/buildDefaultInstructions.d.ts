 ...
 * );
 */
export declare const buildDefaultInstructions: (baseParams: BaseInstructionsParams, instructions: BuildDefaultParameters) => Promise<Instruction[]>;
export default buildDefaultInstructions;
//# sourceMappingURL=buildDefaultInstructions.d.ts.map