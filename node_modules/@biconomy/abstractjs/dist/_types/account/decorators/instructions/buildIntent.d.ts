 ...
 * );
 */
export declare const buildIntent: (baseParams: BaseInstructionsParams, parameters: BuildIntentParameters) => Promise<Instruction[]>;
export default buildIntent;
//# sourceMappingURL=buildIntent.d.ts.map