 ...
 * );
 */
export declare const getExplorerTxLink: (hash: Hex, chain_: Chain | number | string) => Url;
/**
 ...
 */
export declare const getJiffyScanLink: (userOpHash: Hex) => Url;
/**
 ...
 */
export declare const getMeeScanLink: (hash: Hex) => Url;
