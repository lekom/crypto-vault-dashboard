...
import { type GrantPermissionParameters, type GrantPermissionResponse, grantPermissionPersonalSign, grantPermissionTypedDataSign } from "./grantPermission";
...
export type SmartSessionActions<TModularSmartAccount extends ModularSmartAccount | undefined> = {
     ...
     */
    grantPermissionPersonalSign: (args: GrantPermissionParameters<TModularSmartAccount>) => Promise<GrantPermissionResponse>;
    /**
     ...
     */
    grantPermissionTypedDataSign: (args: GrantPermissionParameters<TModularSmartAccount>) => Promise<GrantPermissionResponse>;
    /**
...
export { meeSessionActions, grantMeePermissionPersonalSign, grantMeePermissionTypedDataSign, useMeePermission } from "./mee";
